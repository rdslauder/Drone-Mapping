...
batch_prefix = input("Enter the batch number: ")
...
for i, filename in enumerate(os.listdir(folder_path)):
    ...
    if os.path.splitext(filename)[1].lower() in ['.jpg', '.jpeg', '.png', '.bmp', '.gif']:
        ...
        new_filename = batch_prefix + '#' + str(start_index) + '.jpg'
...
print("All image files in the directory have been renamed with the batch number '" + prefix + "'#")
